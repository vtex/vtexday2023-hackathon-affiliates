...
export const messages = defineMessages({
  ...
  affiliatesOrdersTableOrderIdColumnLabel: {
    id: 'admin/affiliatesOrders.table.orderId.header',
  },
  affiliatesOrdersTableAffiliateIdColumnLabel: {
    id: 'admin/affiliatesOrders.table.affiliateId.header',
  },
  ...
  commissionLabel: { id: 'admin/commissionPercentage .label' },
  ...
  commissionPercentage: { id: 'admin/commissionPercentage.label' },
